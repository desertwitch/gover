...
func (_m *Share) GetCachePool() storage.Pool {
	ret := _m.Called()
	...
	var r0 storage.Pool
	if rf, ok := ret.Get(0).(func() storage.Pool); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(storage.Pool)
		}
	}
...
func (_c *Share_GetCachePool_Call) Return(_a0 storage.Pool) *Share_GetCachePool_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Share_GetCachePool_Call) RunAndReturn(run func() storage.Pool) *Share_GetCachePool_Call {
	_c.Call.Return(run)
	return _c
}

// GetCachePool2 provides a mock function with no fields
func (_m *Share) GetCachePool2() storage.Pool {
	ret := _m.Called()
...
func (_c *Share_GetCachePool2_Call) Return(_a0 storage.Pool) *Share_GetCachePool2_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Share_GetCachePool2_Call) RunAndReturn(run func() storage.Pool) *Share_GetCachePool2_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Share) GetExcludedDisks() map[string]storage.Disk {
	ret := _m.Called()
...
// Share_GetExcludedDisks_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetExcludedDisks'
type Share_GetExcludedDisks_Call struct {
	*mock.Call
}

// GetExcludedDisks is a helper method to define mock.On call
func (_e *Share_Expecter) GetExcludedDisks() *Share_GetExcludedDisks_Call {
	return &Share_GetExcludedDisks_Call{Call: _e.mock.On("GetExcludedDisks")}
}

func (_c *Share_GetExcludedDisks_Call) Run(run func()) *Share_GetExcludedDisks_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Share_GetExcludedDisks_Call) Return(_a0 map[string]storage.Disk) *Share_GetExcludedDisks_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Share_GetExcludedDisks_Call) RunAndReturn(run func() map[string]storage.Disk) *Share_GetExcludedDisks_Call {
	_c.Call.Return(run)
	return _c
}

// GetIncludedDisks provides a mock function with no fields
func (_m *Share) GetIncludedDisks() map[string]storage.Disk {
	ret := _m.Called()
...
func (_c *Share_GetIncludedDisks_Call) Return(_a0 map[string]storage.Disk) *Share_GetIncludedDisks_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Share_GetIncludedDisks_Call) RunAndReturn(run func() map[string]storage.Disk) *Share_GetIncludedDisks_Call {
	_c.Call.Return(run)
	return _c
}
