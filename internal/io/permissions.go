...
// ensurePermissions sets permissions and ownership for a given path based on
// its [schema.Metadata].
...
// ensureLinkPermissions sets permissions and ownership for a given link path
// based on its [schema.Metadata].
