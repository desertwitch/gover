...
func (_m *FsProvider) ExistsOnStorage(m *filesystem.Moveable) (unraid.UnraidStoreable, string, error) {
	ret := _m.Called(m)
	...
	var r0 unraid.UnraidStoreable
	var r1 string
	var r2 error
	if rf, ok := ret.Get(0).(func(*filesystem.Moveable) (unraid.UnraidStoreable, string, error)); ok {
		return rf(m)
	}
	if rf, ok := ret.Get(0).(func(*filesystem.Moveable) unraid.UnraidStoreable); ok {
		r0 = rf(m)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(unraid.UnraidStoreable)
		}
	}

	if rf, ok := ret.Get(1).(func(*filesystem.Moveable) string); ok {
		r1 = rf(m)
	} else {
		r1 = ret.Get(1).(string)
	}

	if rf, ok := ret.Get(2).(func(*filesystem.Moveable) error); ok {
		r2 = rf(m)
	} else {
		r2 = ret.Error(2)
	}
...
func (_c *FsProvider_ExistsOnStorage_Call) Return(storeable unraid.UnraidStoreable, existingAtPath string, err error) *FsProvider_ExistsOnStorage_Call {
	_c.Call.Return(storeable, existingAtPath, err)
	return _c
}

func (_c *FsProvider_ExistsOnStorage_Call) RunAndReturn(run func(*filesystem.Moveable) (unraid.UnraidStoreable, string, error)) *FsProvider_ExistsOnStorage_Call {
	_c.Call.Return(run)
	return _c
}

// HasEnoughFreeSpace provides a mock function with given fields: s, minFree, fileSize
func (_m *FsProvider) HasEnoughFreeSpace(s unraid.UnraidStoreable, minFree int64, fileSize int64) (bool, error) {
	...
	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(unraid.UnraidStoreable, int64, int64) (bool, error)); ok {
		return rf(s, minFree, fileSize)
	}
	if rf, ok := ret.Get(0).(func(unraid.UnraidStoreable, int64, int64) bool); ok {
		r0 = rf(s, minFree, fileSize)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(unraid.UnraidStoreable, int64, int64) error); ok {
...
func (_c *FsProvider_HasEnoughFreeSpace_Call) Run(run func(s unraid.UnraidStoreable, minFree int64, fileSize int64)) *FsProvider_HasEnoughFreeSpace_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(unraid.UnraidStoreable), args[1].(int64), args[2].(int64))
	})
	return _c
}
...
func (_c *FsProvider_HasEnoughFreeSpace_Call) RunAndReturn(run func(unraid.UnraidStoreable, int64, int64) (bool, error)) *FsProvider_HasEnoughFreeSpace_Call {
	_c.Call.Return(run)
	return _c
}
