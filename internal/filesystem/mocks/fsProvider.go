...
func (_m *FsProvider) ExistsOnStorage(m *filesystem.Moveable) (unraid.Storeable, string, error) {
	ret := _m.Called(m)
	...
	var r0 unraid.Storeable
	var r1 string
	var r2 error
	if rf, ok := ret.Get(0).(func(*filesystem.Moveable) (unraid.Storeable, string, error)); ok {
		return rf(m)
	}
	if rf, ok := ret.Get(0).(func(*filesystem.Moveable) unraid.Storeable); ok {
		r0 = rf(m)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(unraid.Storeable)
		}
	}
...
func (_c *FsProvider_ExistsOnStorage_Call) Return(storeable unraid.Storeable, existingAtPath string, err error) *FsProvider_ExistsOnStorage_Call {
	_c.Call.Return(storeable, existingAtPath, err)
	return _c
}

func (_c *FsProvider_ExistsOnStorage_Call) RunAndReturn(run func(*filesystem.Moveable) (unraid.Storeable, string, error)) *FsProvider_ExistsOnStorage_Call {
	_c.Call.Return(run)
	return _c
}
