...
func (_m *OsProvider) ReadDir(name string) ([]os.DirEntry, error) {
	ret := _m.Called(name)
...
func (_c *OsProvider_ReadDir_Call) Return(_a0 []os.DirEntry, _a1 error) *OsProvider_ReadDir_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *OsProvider_ReadDir_Call) RunAndReturn(run func(string) ([]os.DirEntry, error)) *OsProvider_ReadDir_Call {
	_c.Call.Return(run)
	return _c
}
