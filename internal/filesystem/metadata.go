...
const (
	...
	// This base is used to calculate the "Chmod" value when restoring
	// permissions.
	unixBasePerms = 0o777
)

// establishMetadata stores in a given [schema.Moveable] its filesystem
// metadata.
...
// getMetadata retrieves for a given path the [schema.Metadata] from the
// filesystem.
