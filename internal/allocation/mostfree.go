...
func (a *Handler) allocateMostFree(m *filesystem.Moveable, includedDisks map[string]filesystem.DiskType, excludedDisks map[string]filesystem.DiskType) (filesystem.DiskType, error) {
