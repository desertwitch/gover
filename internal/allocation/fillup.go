...
func allocateFillUpDisk(m *filesystem.Moveable, includedDisks map[string]*unraid.UnraidDisk, excludedDisks map[string]*unraid.UnraidDisk, fs fsAdapter) (*unraid.UnraidDisk, error) {
