...
// allocateHighWater provides the allocation logic for the high-water allocation
// method. It selects the lowest-numbered [schema.Disk] with free space above a
// dynamic threshold that starts at half the largest disk's capacity and halves
// when no suitable disk is found.
